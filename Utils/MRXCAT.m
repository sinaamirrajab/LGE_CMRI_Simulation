...
% 
% The MRXCAT superclass contains all common properties and methods of MRXCAT_CMR_PERF and MRXCAT_CMR_CINE and MRXCAT_CMR_LGE.
% 
% NOTE:     Do not call MRXCAT directly, but use MRXCAT_CMR_PERF or MRXCAT_CMR_CINE or MRXCAT_CMR_LGE instead.
% 
% PROPERTIES:
% 
...
classdef MRXCAT < handle
    ...
    methods
            ...
            if ( fid ~= -1 )
                while ( ~feof( fid ) )
                    ...
                    elseif strcmp(str, 'pericardium_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.pericardium_activity  = fscanf( fid,'%f',1);
                        ...
                        %
                    elseif strcmp(str, 'st_wall_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.st_wall_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'st_cnts_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.st_cnts_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'Scar1'                      ) fscanf(fid,'%s',1); MRX.Par.act.scar1             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'Scar2'                      ) fscanf(fid,'%s',1); MRX.Par.act.scar2             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'Scar3'                      ) fscanf(fid,'%s',1); MRX.Par.act.scar3             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'Scar4'                      ) fscanf(fid,'%s',1); MRX.Par.act.scar4             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'BZ1'                      ) fscanf(fid,'%s',1); MRX.Par.act.bz1             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'BZ2'                      ) fscanf(fid,'%s',1); MRX.Par.act.bz2             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'BZin'                      ) fscanf(fid,'%s',1); MRX.Par.act.bzin             = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'BZout'                      ) fscanf(fid,'%s',1); MRX.Par.act.bzout             = fscanf( fid,'%f',1);
  
                        
                        
                    elseif strcmp(str, 'right'                          ) str = fscanf( fid, '%s', 1 );
                    if strcmp(str, 'lung_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.r_lung_activity               = fscanf( fid,'%f',1);
                    else
                    if strcmp(str, 'kidney_cortex_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.r_kidney_cortex_activity               = fscanf( fid,'%f',1); end  
                    if strcmp(str, 'kidney_medulla_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.r_kidney_medulla_activity               = fscanf( fid,'%f',1); end
                    if strcmp(str, 'renal_pelvis_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.r_renal_pelvis_activity              = fscanf( fid,'%f',1); end

                    
                    %add here for right ?? organ
                    end

                    elseif strcmp(str, 'left'                          ) str = fscanf( fid, '%s',1);
                     if strcmp(str, 'lung_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.l_lung_activity               = fscanf( fid,'%f',1); 
                        else
                     if strcmp(str, 'kidney_cortex_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.l_kidney_cortex_activity               = fscanf( fid,'%f',1); end
                     if strcmp(str, 'kidney_medulla_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.l_kidney_medulla_activity               = fscanf( fid,'%f',1); end
                     if strcmp(str, 'renal_pelvis_activity'                          ) fscanf(fid,'%s',1); MRX.Par.act.l_renal_pelvis_activity              = fscanf( fid,'%f',1); end

                      %add here for left ?? organ
                     end
               

                    elseif strcmp(str, 'esophagus_contents_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.esophagus_contents_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'esophagus_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.esophagus_activity  = fscanf( fid,'%f',1);

                    elseif strcmp(str, 'adrenal_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.adrenal_activity  = fscanf( fid,'%f',1);

                    elseif strcmp(str, 'cartilage_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.cartilage_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'spleen_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.spleen_activity  = fscanf( fid,'%f',1);
                    
                    elseif strcmp(str, 'asc_large_intest_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.asc_large_intest_activity    = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'trans_large_intest_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.trans_large_intest_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'desc_large_intest_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.desc_large_intest_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'small_intest_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.small_intest_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'intest_air_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.intest_air_activity  = fscanf( fid,'%f',1);
                    elseif strcmp(str, 'gall_bladder_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.gall_bladder_activity  = fscanf( fid,'%f',1);
                  

                    elseif strcmp(str, 'pancreas_activity'           ) fscanf(fid,'%s',1); MRX.Par.act.pancreas_activity  = fscanf( fid,'%f',1);
        ...
        function img = readImgData(MRX,t)
            ...
            if MRX.Par.scan.resp || strcmpi(class(MRX), 'MRXCAT_CMR_LGE')
                fname = [fname(1:end-5),sprintf('%d',t),'.bin'];
            end
        ...
        function saveNifti(MRX, KSPACE, msk)
              ...
              filename = [MRX.Par.scan.name,'_',num2str(MRX.Par.scan.ti),'_',num2str(MRX.Par.scan.lowpass_str(1)),'_',num2str(MRX.Par.scan.lowpass_str(2)),'_',num2str(MRX.Par.scan.lowpass_str(3)),'_SNR_',num2str(MRX.Par.scan.snr)];     
        ...
        function sen = calculateCoilMaps( MRX )
            ...
            if MRX.Par.scan.coils>1
                ...
                % -----------------------------------------------------------------
                % calculate sensitivity for each coil -removed
                % -----------------------------------------------------------------
...
%                 t25z = tukeywin(Lz,0.5);
                [maskt25x,maskt25y]=meshgrid(t25x,t25y);
                Bt25xyz=maskt25x.*maskt25y;
                
                Bt25 = padarray(Bt25xyz,[(XCATsize(1)-(nx))/2,(XCATsize(2)-(ny))/2],'both');

        %========== the size of the K-space is calculated based on the number
        %of non zero measurments of the k-space which defined by the number of non
        %zero points of the Turkey window
                  

        %instead of slice averaging I dounsample in Z direction from the high
        %resolution image in z direction to desired slice number

imglow = imresize3(img,[size(img,1),size(img,2),nz],'cubic');
% imglow = img;
KSPACE = zeros (sqrt(size(find(Bt25),1)),sqrt(size(find(Bt25),1)),size(imglow,3));
        ...
        %==========loop over coils and slices
              ...
              for i=1:size(imglow,3)
                ...
                KSPACE(:,:,i) = reshape(KSPACEzeropad(KSPACEzeropad~=0),(size((Bt25xyz),1)-2) , (size((Bt25xyz),2)-2));
               
                imglow(:,:,i,j) = ifft2c(KSPACEzeropad);
                
%               img(:,:,i,j)=abs(ifftshift(ifftshift(ifft2(A.*imgks))));
%               img(:,:,i,j)=abs(ifftshift(ifftshift(ifft2(Bt25.*imgks))));
              end  
              end
               img = imglow;
               msk = imresize3(msk,size(KSPACE),'nearest');
